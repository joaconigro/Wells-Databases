...
Public Class PrecipitationsViewModel
    ...
    Private _Entities As IQueryable(Of Precipitation)
    ...
    Public Overrides ReadOnly Property Entities As IEnumerable(Of Precipitation)
        Get
    ...
    Public Overrides Property SelectedEntities As IEnumerable(Of Precipitation)
        Get
